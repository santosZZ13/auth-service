...
import org.authen.configuration.security.resolver.BearerTokenResolver;
...
//		}
	...
	protected void doFilterInternal(@NotNull HttpServletRequest request, @NotNull HttpServletResponse response,
		...
		if (Objects.isNull(token)) {
			this.logger.trace("Did not find bearer token, will continue with filter chain");
			filterChain.doFilter(request, response);
			return;
		}
		...
		bearerTokenAuthenticationToken.setDetails(new WebAuthenticationDetailsSource().buildDetails(request));
