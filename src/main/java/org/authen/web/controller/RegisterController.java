...
public class RegisterController {
	...
	public ResponseEntity<GenericResponse> registerAccount(@RequestBody RegisterDTORequest registerDTORequest, HttpServletRequest request) {
	...
	public ResponseEntity<GenericResponse> confirmRegistration(@RequestParam("token") String token, HttpServletRequest request) {
